...
<section class="contact__help p-relative pb-5 mt-neg-5">
	<div class="contact__shape">
		<img class="dot" src="assets/img/icon/contact/dot.png" alt="">
		<img class="shape" src="assets/img/icon/contact/shape.png" alt="">
	</div>
	<div class="container">
		<div class="row">
				...
				<div class="contact__help-item white-bg text-center mb-30 wow fadeInLeft px-4 pb-3" data-wow-delay=".3s">
					<div class="contact__text">
						<form method="POST" action="{{ route('register') }}">
							...
							<div class="form-group row">
								<div class="col-12">
									<button type="submit" class="z-btn">{{ __('Register') }}</button>
								</div>
							</div>
